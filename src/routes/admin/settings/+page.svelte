...
<div class="px-4 lg:px-6">
  <div class="mb-8">
    ...
    <p class="text-muted-foreground text-sm">System configuration</p>
  </div>
  ...
  <div class="grid gap-6 md:grid-cols-2">
    <Card>
      ...
      <CardContent>
        <p class="font-mono text-sm">{data.nodeVersion}</p>
      </CardContent>
    </Card>
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <p class="font-mono text-sm">{data.smtpHost}:{data.smtpPort || '—'}</p>
      </CardContent>
    </Card>
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <p class="font-mono text-sm">{data.posthogHost}</p>
      </CardContent>
    </Card>
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <p class="font-mono text-sm">{data.pocketBaseUrl}</p>
      </CardContent>
    </Card>
  </div>
