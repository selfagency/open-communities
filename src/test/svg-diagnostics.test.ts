...
test('svg import shapes', async () => {
  ...
  console.log('findMod default value (truncated):', String((findMod as Record<string, unknown>).default).slice(0, 200));
  ...
  console.log('maskMod default value (truncated):', String((maskMod as Record<string, unknown>).default).slice(0, 200));
  ...
  console.log('aslMod default value (truncated):', String((aslMod as Record<string, unknown>).default).slice(0, 200));
