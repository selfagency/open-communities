...
test('svg import shapes', async () => {
	...
	console.log(
		'findMockDirect keys:',
		Object.keys((findMockDirect || {}) as Record<string, unknown>)
	);
	console.log(
		'findMockDirect default type:',
		typeof (findMockDirect as Record<string, unknown>)['default']
	);
	console.log(
	...
	console.log(
		'maskMockDirect keys:',
		Object.keys((maskMockDirect || {}) as Record<string, unknown>)
	);
	console.log(
		'maskMockDirect default type:',
		typeof (maskMockDirect as Record<string, unknown>)['default']
	);
	console.log(
	...
	console.log(
		'aslMockDirect default type:',
		typeof (aslMockDirect as Record<string, unknown>)['default']
	);
	console.log(
