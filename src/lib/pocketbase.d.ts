...
export type AccessibilityResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<AccessibilityRecord>;
...
export type CongregationsResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<CongregationsRecord>;
...
export type CountriesResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<CountriesRecord>;
...
export type RegistrationResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<RegistrationRecord>;
...
export type SecurityResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<SecurityRecord>;
...
export type ServicesResponse<Texpand = unknown> = BaseSystemFields<Texpand> &
	Required<ServicesRecord>;
