...
export type CongregationMetaResponse<Taccessibility = unknown, Tfit = unknown, Thealth = unknown, Tlocation = unknown, Tregistration = unknown, Tsecurity = unknown, Tservices = unknown, Texpand = unknown> = BaseSystemFields<Texpand> & Required<CongregationMetaRecord<Taccessibility, Tfit, Thealth, Tlocation, Tregistration, Tsecurity, Tservices>>
