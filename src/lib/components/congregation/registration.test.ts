...
describe('Registration component', () => {
  ...
  it('renders otherText when registrationType is other', () => {
    const registration = { otherText: 'Register at the door', registrationType: 'other' } as unknown as RegistrationRecord;
    render(Registration, { registration });
  ...
  it('renders email and website buttons when provided', () => {
    const registration = { email: 'r@test.com', url: 'https://example.com' } as unknown as RegistrationRecord;
    render(Registration, { registration });
