...
>
  <Find
    aria-hidden="true"
    class="absolute -top-10 -left-5 hidden w-24 fill-foreground dark:fill-background sm:block  sm:w-32 lg:-left-10"
  />
  <Inclusive
    aria-hidden="true"
    class="absolute -right-5 -bottom-10 hidden w-24 fill-foreground dark:fill-background  sm:block sm:w-32 lg:-right-10"
  />
