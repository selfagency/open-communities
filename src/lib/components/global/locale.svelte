...
<DropdownMenu.Root>
  ...
  >
    <LocaleIcon class="h-4 w-4 {mode === 'mini' ? 'text-foreground' : 'stroke-muted-foreground'} transition-transform duration-200 motion-safe:hover:scale-110 motion-safe:active:scale-90" />
