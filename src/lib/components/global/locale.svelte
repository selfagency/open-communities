...
<DropdownMenu.Root>
  <DropdownMenu.Trigger
    aria-label={m.selectLanguage()}
    class={'group ' + (mode === 'mini' ? 'text-foreground underline-offset-4 hover:underline inline-flex items-center gap-2 px-4 py-2 text-sm' : buttonClass)}
  >
    <LocaleIcon
