...
<form method="POST" {action} use:enhance={handleEnhance} onsubmit={beforeSubmit} class="space-y-6">
  ...
  {#if page?.id}
    <input type="hidden" name="id" value={page.id as string} />
  {/if}
