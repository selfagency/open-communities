...
<Accordion.Item value="contact">
  ...
  <Accordion.Content>
    <div class="question mb-4">{m.contactName_extended()}</div>
    <Form.Field {form} name="contactName">
      <Form.Control
        >{#snippet children(props)}
          ...
          <Input id="contactName" {...props} bind:value={$formData.contactName} />
        {/snippet}
      </Form.Control>
      <Form.FieldErrors />
    </Form.Field>
    <div class="question my-4">{m.contactEmail_extended()}</div>
    <Form.Field {form} name="contactEmail">
      <Form.Control
        >{#snippet children(props)}
          ...
          <Input id="contactEmail" {...props} bind:value={$formData.contactEmail} />
        {/snippet}
      </Form.Control>
      <Form.FieldErrors />
    </Form.Field>
