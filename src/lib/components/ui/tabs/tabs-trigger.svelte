...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		"data-active:bg-white dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 data-active:text-foreground data-active:shadow-sm",
