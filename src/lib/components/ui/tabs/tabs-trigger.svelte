...
<TabsPrimitive.Trigger
  ...
  class={cn(
		...
		"data-active:bg-white data-active:border-border data-active:text-foreground data-active:shadow-sm dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30",
