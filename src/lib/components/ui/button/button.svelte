	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-border bg-white hover:bg-muted hover:text-foreground shadow-xs dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground",
