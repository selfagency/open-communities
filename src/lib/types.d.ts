...
export type AccommodationsResponse<Texpand = unknown> = Required<AccommodationsRecord> &
...
export type CongregationMetaResponse<
	...
	Texpand = unknown
> = Required<
	CongregationMetaRecord<Taccommodations, Tfit, Tlocation, Tregistration, Tsafety, Tservices>
> &
	BaseSystemFields<Texpand>;
export type CongregationsResponse<Texpand = unknown> = Required<CongregationsRecord> &
	BaseSystemFields<Texpand>;
...
export type RegistrationResponse<Texpand = unknown> = Required<RegistrationRecord> &
	BaseSystemFields<Texpand>;
